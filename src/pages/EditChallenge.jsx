...
function EditChallenges() {
  ...
  // Redirect if challenge is not user's
  useEffect(() => {
    if (challenge && challenge.userRef !== auth.currentUser.uid) {
      toast.error('You can not edit that challenge')
      navigate('/')
    }
  })
  ...
  useEffect(() => {
    ...
    const fetchChallenge = async () => {
      ...
      if (docSnap.exists()) {
        ...
        navigate('/')
        toast.error('Challenge does not exist')
      }
    }
    fetchChallenge()
  }, [params.challengeId, navigate])
  ...
  return (
    <div className='profile'>
      <header>
        <p className='pageHeader'>Edit Challenge</p>
      </header>
